...
public class SearchResultPage extends BrowserUtility{
	...
	public boolean isSearchedtermPresentInProductList(String searchedTerm) {
		List<String> keywords=Arrays.asList(searchedTerm.toLowerCase().split(" "));
		List<String> productNameList=getAllVisibleTexts(ALL_PRODUCT_LISTS_NAME);
